...
from ..utils import aenumerate, data_iter, iter_path, norm_path
...
class OneDriveTransferUploadTask:
    ...
    async def run(self, remote_path):
        ...
        try:
            upload_url_request = await self.client.get_upload_url(remote_path)
        ...
        try:
            ...
            async for i, file_piece in aenumerate(
                ...
                r = await ahttpx.put(upload_url, data=data, headers=headers)
